    ...
    $.each(lines, function(index){
      ...
      $.ajax({
        ...
        success: function(json){
          console.log(json);
          // #TODO: move away logic to extract data from the json into a custom object
          write_result_to_table($('#results-table'), index, json.feed.entry[0].link[0].href, json.feed.entry[0].title.$t );
          return index;
        }
      });
    });
